...
DialogFactory::CreateInventoryDialog()
{
  try {
    ...
    panel->AddActiveWidget(widgetFactory.CreateInventory(Rectangle(105, 11, 202, 121), GameApplication::GetInstance()->GetGame()->GetParty()->GetSelectedMember(), icons, font.GetFont()));
    return dialog;
  } catch (Exception &e) {
