...
static const unsigned int ACT_STOP          = 1025;
static const unsigned int ACT_UP            = 1026;
static const unsigned int ACT_DOWN          = 1027;
static const unsigned int ACT_LEFT          = 1028;
static const unsigned int ACT_RIGHT         = 1029;
